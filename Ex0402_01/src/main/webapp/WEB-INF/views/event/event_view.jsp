		...
		//컨트롤러에 보내서 저장하기 위해서 ajax를 쓰는것이다
	  	 $.ajax({
			...
			success: function(data){
				...
				var date = data.dto.commentDate;
				var realdate = moment(date).format('YYYY-MM-DD HH:mm:ss');
...
/*  function commentUpdate(commentNo,id,commentDate,commentContent){
	...
	$.ajax({
			...
			success: function(data){
				...
				html +='<li class="name">'+data.dto.id+'<span>['+realdate+']</span></li>';
				html +='<li class="txt"><textarea class="replyType">'+data.dto.commentContent+'</textarea></li>';
				html +='<li class="btn">';
				html +='<a href="#" class="rebtn"';
				html +='onclick="commentUpdateCheck('+data.dto.commentNo+',\''+data.dto.id+'\',\''+realdate+'\',\''+data.dto.commentContent+'\'>;
				html +='저장</a>';
...
function commentWrite(){
	...
	//컨트롤러에 보내서 저장하기 위해서 ajax를 쓰는것이다
		...
		success: function(data){	//data.dto.id
			...
			html +='<li class="btn">';
			html +='<a href="" class="rebtn"';
			html +='onclick="commentUpdate('+data.dto.commentNo+',\''+data.dto.id+'\',\''+realdate+'\',\''+data.dto.commentContent+'\')">';
			html +='수정</a>';								
			html +='<a href="#" class="rebtn">삭제</a>';
			html +='</li>';
			html +='</ul>';
